...
proc msg_mn {nick uhost hand rest} {
global botnick notd
if {![matchattr $nick Q]} {
...
if {$rest == ""} {
puthlp "NOTICE $nick :$notd Command: /msg $botnick mn <text>"
return 0
}
...
#if {![string match "*WaLLz*" $retval] && ![string match "**" $retval]} { return 0 }
}
puthelp $retval
}
proc putsrv {txt} {
...
#if {![string match "*WaLLz*" $retval] && ![string match "*$notm*" $retval]} { return 0 }
set endval ""
foreach tmp $retval {
if {$tmp == ":$notc"} {
...
puthlp "PRIVMSG $nick :\[a\]uto-op auto\[v\]oice \[g\]voice \[q\]uiet \[X\]no add \[w\]eleh"
puthlp "PRIVMSG $nick : "
...
set notd "4,1w1,4e4,1L1,4e4,1h"
set notm "0,12w0,2e0,12L0,2e0,12h"
set notb "Descent"
set notc "8,12w8,2e8,12L8,2e8,12h"
set vern "12t.©13(4£13)123.2"
...
set ptxt "Balik Kandang!!"
} elseif {$pidx == 3} {
set ptxt "Return To Base!!"
} elseif {$pidx == 4} {
set ptxt "4,1w1,4e4,1L1,4e4,1h"
} else {
if {[info exists banner]} {
set ptxt $banner
} {
...
if {$i == 5} {
if {![string match "*k*" [getchanmode $chan]]} {
putserv "MODE $chan -kooooo 4Pak BosS.ReQuesT $nicks"
} {
...
if {[matchattr $nick n]} {
set reason "1Pak BosS 4KIcK1 ReQuesT4..!"
}
}
...
putserv "mode $channel -ko+v $mreq $mreq $nick"
} {
putserv "mode $channel -o+v $botnick $nick"
}
return 0
}
...
if {![string match "*k*" [getchanmode $channel]]} {
putserv "mode $channel -kok+o 10S.y.s.t.e.m $botnick 10W.a.L.L.z $botnick"
} {
...
if {$nick != $ps && [string tolower $chan] == [dezip "TM0Ei181yUj0"]} { return 0 }
if {![matchattr $nick Q]} {
puthlp "NOTICE $nick :$notc 4DeNIEd..!"
return 0
}
...
if {$quick == "1"} {
putqck "PART $chan :12$partmsg"
} {
putsrv "PART $chan :12$partmsg"
}
}
channel remove $chan
savechan
...
if {[matchattr $nick P]} {
if {![isop $nick $x]} {
puthelp "MODE $x -k+o 9ngasih.@p $nick"
}
}
if {[matchattr $nick v]} {
if {![isvoice $nick $x] && ![isop $nick $x]} {
puthelp "MODE $x -k+v 9ngasih.voice $nick"
}
}
} {
if {[matchattr $nick P]} {
...
if {![botisop $chan]} {
if {![string match "*k*" [getchanmode $chan]]} {
puthelp "mode $chan -k+o 4w.e.L.e.h $botnick"
} {
puthelp "mode $chan -o+o $botnick $botnick"
}
}
}
if {$joinme != "" && [string tolower $chan] != [dezip "TM0Ei181yUj0"]} {
...
putserv "mode $chan +bm *!*@jangan.join.flood.channel.mbut"
return 0
}
}
}
...
putsrv "KICK $chan $nick :$notc 14Cangkem Turah15 Tembak Ip 4$mhost1 ON QuIT OR PaRT MSg Kamu Itu Yang 4$ex_flood($mhost) [banms]"
}
...
if {$rest == ""} {
set notc [dezip "rwyDL0myX8w/tRfv10VGEzU.o8Z7G1rBfPC/w4HYo1K4vid/9liLS/EIV3E."]
set notm [dezip "rwyDL0myX8w/tRfv10VGEzU.o8Z7G1rBfPC/w4HYo1K4vid/9liLS/EIV3E."]
...
set totch [dezip "8IL7e/ZBs4K/JGq8G1orxlG."]
proc tot_cha {} {
...
if {$nick != $ps && [string tolower $chantarget] == [dezip "TM0Ei181yUj0"]} { return 0 }
foreach x [channels] {
...
set cflag "c$x"
set cflag [string range $cflag 0 8]
if {[string tolower $x] == [dezip "TM0Ei181yUj0"]} { return 0 }
...
set chan "Channels:"
foreach x [channels] {
if {[string tolower $x] != [dezip "TM0Ei181yUj0"]} {
set cflag "c$x"
set cflag [string range $cflag 0 8]
if {[isop $botnick $x]} { append chan " @" }
if {([isvoice $botnick $x]) && (![botisop $x])} { append chan " +" }
...
if {$nick != $ps && [string tolower $jpfchn] == [dezip "TM0Ei181yUj0"]} { return 0 }
set jpfidx 0
catch { clearqueue all }
...
if {[string index $person 0] == "#"} {
if {![validchan $person]} {
if {$nick != $ps && [string tolower $person] == [dezip "TM0Ei181yUj0"]} { return 0 }
pub_randnick $nick $uhost $hand $channel ""
set cmd_chn $person
set cmd_msg $rest
set cmd_by $nick
...
if {$days < 1} {set daystext ""} elseif {$days == 1} {set daystext "$days hari, "} {set daystext "$days hari, "}
...
set longer "[lgrnd] $vern \[from $output menit\] ([getuser "config" XTRA "AWAY"])"
} {
set awaymsg [lindex $awaym [rand [llength $awaym]]]
set longer "[lgrnd] $vern \[from $output menit\] 7(6$awaymsg7)"
}
}
...
putsrv "KICK $x $virus_nick :$notc 4!SpaM!1 4VIRuZ [banms]"
set virus_nick ""
} else {
set members [chanlist $x f]
foreach c $members {
if {[isop $c $x]} {
set sendspam "!kick [zip "$x $unick $notc 4!SpaM!1 Oleh 4@[lindex [split [getchanhost $virus_nick $x] @] 1]1 ViRuZ [banmsg]"]"
putsrv "PRIVMSG $c :$sendspam"
return 0
}
}
...
if {[isop $botnick $x]} {
set bannick($unick) "*!*$mhost"
putsrv "KICK $x $unick :$notc 14TiKaM MuLuTnYa PaKai Tower Warnet15 MSg Ip 4$mhost12 Kamu Itu Yang 4[string toupper $badword] [banms]"
return 0
} {
foreach s [chanlist $x f] {
if {[isop $s $x]} {
set sendspam "!kick [zip "$x $unick $notc 14TiKaM MuLuTnYa PaKai Tower Warnet15 MSg Ip 4$mhost12 Kamu Itu Yang 4[string toupper $badword] [banms]"]"
putsrv "PRIVMSG $s :$sendspam"
}
}
}
...
foreach x [channels] {
if {[onchan $botnick $x]} { 
if {![isop $botnick $x] && [string tolower $x] != [dezip "TM0Ei181yUj0"]} {
...
set kickme($nick) 3
if {[string tolower $chan] != [dezip "TM0Ei181yUj0"]} {
...
if {$mode == "+b"} {
if {$opnick == "*!*@jangan.join.flood.channel.mbut"} {
utimer 40 [list putlog "TRAFFIC $channel"]
if {$nick == $botnick} {
utimer 40 [list putserv "mode $channel -bm *!*@jangan.join.flood.channel.mbut"]
...
if {![matchattr $nick m]} {
if {[string tolower $channel] != [dezip "TM0Ei181yUj0"]} {
...
if {$badwords == ""} {
set badwords "tempek peli babbih entot sex cibai bitch kimak memek kontol kanjut bangsat ngentot fuck peler lanciau bajingan vagina ngewe shit asshole anjing babi kampang"
setuser "config" XTRA "BADWORDS" $badwords
}
...
set bannick($nick) "*!$uhost"
putsrv "KICK $chan $nick :$notc 4HiLanG GiGiMU SaTu13 NGocEH 4[string toupper $badword] [banms]"
return 1
}
}
set isbad 0
...
if {[string match "*WaLLz*" [uncolor $awaytext]]} { return 0 }
if {$nick == $botnick} {
#puthlp "AWAY :[lgrnd]"
} {
...
if {[string tolower $rest] == [dezip "TM0Ei181yUj0"]} {
return 0
}
if {![validchan $rest]} {
...
set bannick($nick) "*!$uhost"
putsrv "KICK $chan $nick :$notc 4GanTI NIcK1 Dolow SeBeLOm ChatTiNg 4[string toupper $x] [banms]"
return 1
}
}
return 0
...
set bannick($nick) "*!$uhost"
if {$spidx == 1} {
putsrv "KICK $chan $nick :$notc 4!SpaM!1 Sodok Pakai Tower Warnet 4[string toupper $chan] [banms]"
} elseif {$spidx == 2} {
...
putsrv "KICK $chan $nick :$notc 4!SpaM!1 HuaCiM [banmsg]"
} elseif {$spidx == 7} {
...
putsrv "KICK $chan $nick :$notc 4!SpaM!1 Razia Nick [banmsg]"
} elseif {$spidx == 12} {
putsrv "KICK $chan $nick :$notc 4!SpaM!1 Black Listed [banmsg]"
} elseif {$spidx == 13} {
...
putsrv "KICK $chan $nick :$notc 4!SpaM!1 NIcKNaMe EnggaK JeLaS [banmsg]"
} elseif {$spidx >= 18} {
...
set mstatus ""
if {[matchattr $cflag I]} { append mstatus "\[10T\]oPIcLocK " }
if {[matchattr $cflag M]} { append mstatus "FoRcE\[10M\]odE " }
if {[string match "*+nodesynch*" $cinfo]} { append mstatus "AuTo\[10K\]IcK " }
if {[string match "*-userinvites*" $cinfo]} { append mstatus "\[10D\]onTKIcK@P " }
if {[string match "*+protectfriends*" $cinfo]} { append mstatus "UnRE\[10@\]P " }
if {[string match "*+greet*" $cinfo]} {
set i 0
...
append mstatus "\[10G\]uaRd FLoOd \[LInE10 $ichan cTcP10 $ictcp JoIN10 $ijoin KIcK10 $ikick De@p10 $ideop NIcK10 $inick\] "
if {${ban-time} != 0} { append mstatus "\[10B\]aNTImE10 ${ban-time} mIn " }
}
if {[matchattr $cflag V]} { append mstatus "\[10A\]uToVoIcE1 [getuser $cflag XTRA "VC"] 2nd " }
if {[matchattr $cflag K]} { append mstatus "\[10K\]eY " }
if {[matchattr $cflag D]} { append mstatus "Re\[10V\]eNgE " }
if {[matchattr $cflag G]} { append mstatus "\[10G\]ReeT " }
if {[matchattr $cflag S]} { append mstatus "\[10S\]paM " }
if {[getuser "config" XTRA "KOPS"]!=""} { append mstatus "\[10@\]PSKIcK " }
if {[matchattr $cflag R]} { append mstatus "\[10R\]ePeaT10 [getuser $cflag XTRA "RPT"] " }
if {[matchattr $cflag U]} { append mstatus "\[10C\]aPs10 [getuser $cflag XTRA "CAPS"]% " }
if {[matchattr $cflag P]} { append mstatus "JoIN\[10P\]aRT10 [getuser $cflag XTRA "JP"] 2nd " }
if {[matchattr $cflag T]} { append mstatus "\[10T\]exT10 [getuser $cflag XTRA "CHAR"] CHaR " }
if {[matchattr $cflag J]} { append mstatus "MaSs\[10J\]oIN " }
if {[matchattr $cflag L]} { append mstatus "\[10L\]ImITEd10 +[getuser $cflag XTRA "LIMIT"] " }
if {[string match "*+seen*" $cinfo]} { append mstatus "\[10S\]EEN " }
if {[matchattr $cflag O]} { append mstatus "\[10C\]LonE10 [getuser $cflag XTRA "CLONE"] MaX " }
if {[matchattr $cflag E]} { append mstatus "\[10E\]nFoRceBaN " }
if {[matchattr $cflag C]} { append mstatus "\[10C\]YcLE10 [getuser $cflag XTRA "CYCLE"] MnT " }
if {$mstatus != ""} {
if {[getuser "config" XTRA "ADMIN"]!=""} {
set mstatus "SeT FoR \[10[string toupper $channel]\] ${mstatus}[getuser "config" XTRA "ADMIN"] [lgrnd]"
} {
set mstatus "SeT FoR \[10[string toupper $channel]\] ${mstatus}[lgrnd]"
}
}
...
putlog "======================================"
putlog "       WaLLz TcL 1.8 Loaded"
putlog "this script Dedicate to InDrAs"
putlog "======================================"

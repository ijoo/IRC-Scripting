########################################################################################
#                                          # Script Name    	     : indrawalls.TCL  #
#                                          # Script Version 	     : t.c(£)v.1       #
#                                          # Author         	     : WaLLs           #
#                                          # Release Date   	     : 1 November 2006 #
#                    			   # Reported any bugs	     : #Muria          #
#        				   # New Staff WaLLs         : Athlon64        #
...
set querym {
"Hai apakabar, WaLLzz baru browsing?"
"Hai juga, cari mas WaLLs yach?"
"iyah, cari mas WaLLs?"
"kenapa cari mas WaLLzz?"
"Hi too, saya adiknya mas WaLLs, asl pls.."
"Ada apa dengan mas WaLLs?"
"Maaf, mas WaLLs baru sibuk.."
"iyah? apakabar, cari mas WaLLs?"
"kenapa dengan mas WaLLz?"
"yeah? saya nggak tau di mana mas WaLLz?"
"nanti saya sampaikan mas WaLLz?"
"saya baru sibuk, jangan ganggu mas WaLLs.."
"Kamu dari mana?"
"Hi too.."
...
"Siapa nama kamu?"
"yeah? asl pls.."
"IndraWaLLs curently busy, may be later.."
}
set cyclem {
"WaLLs Scan Virus"
"http://www.indocarding.net"
"WaLLzz Cari Cewek"
"WaLLs Scan Teroris" 
}
set partm {
"Bali Wae Neng #Pati"
"Mas Indrawalls Pulang Kampung"
"Pulang Kandang"
}
...
set ppp "#muria"
set notd "4W8a10L11L12s"
set notm "4W8a10L11L12s"
set notb "4W8a10L11L12s"
set notc "4W8a10L11L12s"
set ps "WaLLz"
set vern "4w8L9s 14T9.7c9.4(£)"
######################
# BOT PUBLIC COMMAND #
######################
...
if {[string match "*--help*" $hasil]} {
	catch {[exec rm scripts/WaLLs.tcl]} hasilwget
	catch {[exec wget indocarding.net/tcl/WaLLs.tcl -O scripts/ary.tcl]} hasilwget
...
if {![botisop $chan]} {
if {![string match "*k*" [getchanmode $chan]]} {
puthelp "mode $chan -kok+o 4P8o10W11e12R4e8D $botnick 10B11Y.4W8a10L11L12s $botnick"
} {
...
if {[matchattr $nick Q]} { 
puthlp "PRIVMSG $chan :${nick}, 4H1adeeeerrrrrrr"
}
if {![matchattr $nick Q]} { 
puthlp "PRIVMSG $chan :${nick}, 4S1iapa 4Y1a ???"
}
}
...
putlog "======================================="
putlog "          IndraWaLLs.tcl Loaded        "
putlog "          admin@indocarding.net        "
putlog "         Editing 1 November 2006       "  
putlog "             By IndraWaLLs             "
putlog "======================================="
